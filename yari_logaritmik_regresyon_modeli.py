...
print(f" lny = {betalar[0]} + {betalar[1]}X + et \n")


elastikiyet_katsayisi = betalar[1] / np.mean(Y)
...
print("x=7 olduğunda y tahmini bulalım: \n")
y_tahmin = betalar[0] + betalar[1] * 7  # Tahmin edilen değerler
print(f"lny tahmin = {y_tahmin} \n")
y_tahminyildiz = np.exp(y_tahmin)
print(f"y tahmin ise ={y_tahminyildiz} ")
